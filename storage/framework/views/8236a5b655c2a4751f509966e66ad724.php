...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <!-- Link akses ke semua route custom -->
            <div class="mt-6">
                <h2 class="font-bold mb-2">Akses Route:</h2>
                <ul class="list-disc ml-4">
                    <li><a href="<?php echo e(url('/hello')); ?>" class="text-blue-600 underline">/hello</a></li>
                    <li><a href="<?php echo e(url('/about')); ?>" class="text-blue-600 underline">/about</a></li>
                    <li><a href="<?php echo e(url('/halo/Andi')); ?>" class="text-blue-600 underline">/halo/Andi</a></li>
                    <li><a href="<?php echo e(url('/perkalian/4/5')); ?>" class="text-blue-600 underline">/perkalian/4/5</a></li>
                    <li><a href="<?php echo e(url('/salam')); ?>" class="text-blue-600 underline">/salam</a> (tanpa parameter)</li>
                    <li><a href="<?php echo e(url('/salam/Budi')); ?>" class="text-blue-600 underline">/salam/Budi</a> (dengan
                        parameter)</li>
                    <li><a href="<?php echo e(url('/admin/home')); ?>" class="text-blue-600 underline">/admin/home</a></li>
                    <li><a href="<?php echo e(url('/admin/user')); ?>" class="text-blue-600 underline">/admin/user</a></li>
                </ul>
            </div>
            <div
...
</html><?php /**PATH C:\XAMPP\htdocs\belajar_framework\resources\views/welcome.blade.php ENDPATH**/ ?>